...
def test_build_tenant_aware_staff_deeplink() -> None:
    payload = make_staff_payload("n-novgorod", "curator")
    link = build_max_bot_staff_deeplink(
        "@AlgoBot",
        tenant_slug="n-novgorod",
        role="curator",
    )
