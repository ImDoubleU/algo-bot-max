...
Рабочий проект MAX-бота, backend API и приложения для входа по Contact ID, магазина подарков, расписания, заказов, складов и астрокоинов.
...
- куратор: ученики, заказы, начисления, расписание и рассылки по филиалу;
...
В приложении настраиваются расписание и курсы. Права и список групп проверяются
...
и рассылки. Повторный запуск обновляет ту же матрицу без дубликатов.
