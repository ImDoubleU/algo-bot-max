...
- `/schedule` - расписание преподавателя и прямая ссылка на добавление групп и подготовку ОС; aliases: `/teaching`, `/feedback`.
...
Состав кнопок определяется ролью: ученик не видит staff-операции, родитель получает семейные сценарии,
преподаватель - расписание и группы, администратор - операционные действия.
