...
let orders = [
  ...
  {
    id: "1361",
    backendId: "demo-order-1361",
    studentId: "demo-mark",
    rawStatus: "awaiting_delivery",
    student: "Соколов Марк",
    teacherName: "Кузнецов Сергей",
    venueName: "Союзный 45",
    item: "Кружка Python; Ручка металл с лого ×2; Игра Кибертаун",
    warehouse: "Союзный 45, Общий склад",
...
function applySession(session) {
  ...
  students = session.students.map((student) => ({
    ...
    parentConnected: Boolean(student.parent_connected),
