...
STAFF_NOTIFICATION_CATALOG = (
    ...
    _item(
        "orders.transferred",
        "orders",
        "Заказ передан преподавателю",
        "Заказ передан для выдачи ученику.",
        admin=True,
        curator=True,
    ),
    _item(
    ...
    _item(
        ...
        "teaching",
        "Журнал не заполнен",
        "После занятия нет отметок посещаемости.",
        curator=True,
    ),
    _item(
        "lessons.changed",
        "teaching",
        "Занятие изменено",
        "Изменены дата или номер урока.",
        curator=True,
    ),
    _item(
        "schedule.problem",
        "teaching",
        "Проблема в расписании",
        "Нет преподавателя, группы или есть пересечение.",
        admin=True,
        curator=True,
    ),
    _item(
        "attendance.repeated_absence",
        "teaching",
        "Несколько пропусков подряд",
        "Ученик пропустил несколько занятий.",
        curator=True,
    ),
    _item(
        "attendance.group_anomaly",
        "teaching",
        "Много отсутствующих",
        "В группе необычно много пропусков.",
        curator=True,
    ),
    _item(
        "makeups.required",
        "teaching",
        "Требуется отработка",
        "Пропущенное занятие еще не отработано.",
        curator=True,
    ),
    _item(
        "makeups.overdue",
        "teaching",
        "Отработка просрочена",
        "Срок отработки пропуска прошел.",
        curator=True,
    ),
    _item(
        "makeups.completed",
        "teaching",
        "Отработка выполнена",
        "Пропуск отмечен как отработанный.",
        curator=True,
    ),
    _item(
        "feedback.overdue",
        ...
        "Обратная связь не подготовлена вовремя.",
        curator=True,
    ),
    _item(
        "feedback.delivery_failed",
        "teaching",
        "Обратная связь не доставлена",
        "Сообщение родителю не доставлено.",
        curator=True,
    ),
    _item(
