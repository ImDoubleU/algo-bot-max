...
def build_presentation() -> Presentation:
    ...
    add_section_slide(
        ...
        items=[
            ...
            "Управление городами и партнерами суперадминистратором.",
    ...
    add_two_column_slide(
        ...
        callout_text="Выдачу и отзыв ролей выполняют директор, администратор в разрешенных пределах или суперадминистратор.",
        callout_kind="yellow",
    )
    ...
    add_section_slide(
        prs,
        section="Роли 6–7",
        title="Директор и суперадминистратор",
        subtitle="Управление сотрудниками, городами, партнерами и общими настройками.",
        items=[
            "Контроль операционной работы филиала.",
            "Выдача и отзыв ролей сотрудников.",
            "Настройка уведомлений.",
            "Управление несколькими городами директора.",
            "Создание партнеров суперадминистратором.",
        ],
        accent=TEAL,
        background=TEAL_LIGHT,
    )
    ...
    add_screenshot_steps_slide(
        prs,
        kicker="Суперадминистратор",
        title="Партнеры и города",
        screenshot="superadmin-management.png",
        label="Общее управление",
        steps=[
            ("Выберите город", "Текущий рабочий город показан в верхнем переключателе."),
            ("Проверьте данные", "Ученики, товары и сотрудники должны относиться к выбранному партнеру."),
            ("Создайте партнера", "Заполните название, технический идентификатор и основные настройки."),
            ("Назначьте директора", "Свяжите директора с одним или несколькими разрешенными городами."),
        ],
        callout_title="Изоляция партнеров обязательна",
        callout_text="Директор и сотрудники не должны видеть чужие города, группы, заказы или товары.",
        callout_kind="coral",
    )
    ...
    add_two_column_slide(
        prs,
        kicker="Суперадминистратор",
        title="Что настраивается на уровне города",
        left_title="Данные и доступ",
        left_items=[
            "директора и сотрудники;",
            "ученики, группы и связи;",
            "срок доступа после выбытия;",
            "летний период заморозки срока.",
        ],
        right_title="Операционные настройки",
        right_items=[
            "причины и суммы начислений;",
            "товары, склады и остатки;",
            "площадки и правила рассылок;",
            "получатели служебных уведомлений.",
        ],
        callout_title="Проверяйте выбранный город",
        callout_text="Создание и изменение данных всегда применяется к текущему рабочему партнеру.",
        callout_kind="yellow",
    )
    ...
    add_cards_slide(
        ...
        cards=[
            ...
            ("Суперадминистратор", "Изоляция городов, новые партнеры и критичные административные действия.", "purple"),
